...
async function ExitPosition(authdata: AuthData, position: Position, subscriber: DailyGoalSubscriber) {
    try {
...
async function removeDailyGoalSubscriberData(subscriber: DailyGoalSubscriber) {
